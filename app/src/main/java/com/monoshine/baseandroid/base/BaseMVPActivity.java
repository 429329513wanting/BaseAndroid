...
import com.monoshine.baseandroid.module.LoginActivity;
	...
	implements _View
{
    ...
    public void showDialog()
	{
		...
		{
			mSweetAlertDialog
				= new SweetAlertDialog(this, SweetAlertDialog.PROGRESS_TYPE).setTitleText("正在加载数据");
			mSweetAlertDialog.setCancelable(false);
    ...
    public void reLogin()
	{
		showDialog(SweetAlertDialog.WARNING_TYPE, "您的帐号认证失败!", "请重新登录", "确定", null, new SweetAlertDialog.OnSweetClickListener()
		{
			@Override
            public void onClick(SweetAlertDialog sweetAlertDialog)
			{
	...
	{
		ActivityTool.skipActivityAndFinishAll(this, LoginActivity.class);
	}
