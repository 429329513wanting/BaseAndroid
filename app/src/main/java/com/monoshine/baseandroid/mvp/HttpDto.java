...
public class HttpDto implements Serializable
{
	...
	private String errorTitle;//失败信息
	...
	{
		this.url = url;
		this.fullUrl = Constant.getServer()+url;
		this.model = model;
	...
	public HttpDto setErrorTitle(String errorTitle)
	{
	...
	public HttpDto setParam(String key, String value)
	{
		if(params == null)
		{
			params = new HashMap<>();
	...
	public void print()
	{
		...
		if(!RegTool.isNullString(bodyJson))
		{
			...
			builder.append("\n").append(LogTool.formatJson(bodyJson));
		}
